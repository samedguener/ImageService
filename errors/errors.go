...
const (
	...
	// Errors used by middlewares, handlers and services

	// BadRequestHTTP error
	BadRequestHTTP
	// NotFoundHTTP error
	NotFoundHTTP
	// UnauthorizedHTTP error
	UnauthorizedHTTP
	// InternalHTTP error
	InternalHTTP
	// UnprocessableEntityHTTP error
	UnprocessableEntityHTTP
	// NotImplementedHTTP error
	NotImplementedHTTP

	// Errors used by model, repositories and anywhere else
...
func (error customError) Error() string {
	return fmt.Sprintf("%s ", error.originalError.Error())
}
